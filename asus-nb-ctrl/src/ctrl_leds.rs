...
impl CtrlKbdBacklight {
    ...
    pub fn new(
        ...
        let ctrl = CtrlKbdBacklight {
            ...
            led_node: Some(Self::get_node_failover(id_product, None, Self::scan_led_node)?),
            kbd_node: Some(Self::get_node_failover(id_product, condev_iface, Self::scan_kbd_node)?),
